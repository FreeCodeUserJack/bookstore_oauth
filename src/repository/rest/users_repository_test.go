...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody: `{"id":"123","first_name": "john","last_name":"doe","email":"john.doe90@gmail.com"}`,
	})
	...
	assert.NotNil(t, err)
	assert.EqualValues(t, http.StatusInternalServerError, err.Status)
	assert.EqualValues(t, "error trying to umarshal users response", err.Message)
}
...
func TestLoginUserNoError(t *testing.T) {
	...
	assert.EqualValues(t, "john.doe90@gmail.com", user.Email)
}